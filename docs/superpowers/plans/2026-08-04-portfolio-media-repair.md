...
- [ ] **Step 2: Run the test and verify the current five findings**
...
- [ ] **Step 3: Commit the failing regression gate with the subsequent page fixes in Task 2**
...
- [ ] **Step 4: Run the production regression test**

Run: `../.venv-portfolio-quality/bin/python -m unittest tests.test_production_health -v`

Expected: PASS with no static findings.

- [ ] **Step 5: Verify the generated media file**
...
- [ ] **Step 6: Commit the static repairs**
...
- [ ] **Step 5: Run static and live health checks**
...
- [ ] **Step 6: Commit verified content repairs**
...
- [ ] **Step 1: Run the complete suite and health CLI**
...
- [ ] **Step 2: Inspect branch scope and media metadata**
